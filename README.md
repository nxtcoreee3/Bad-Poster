...
<div align="center">
  ...
  <p>
    ...
    · Maintained / iOS 27 port by <a href="https://github.com/Mak5er"><b>Mak5er</b></a>
...
On versions where [bad_query][badQueryGitHub] works, **no computer is required** after sideloading:

1. Install the IPA with TrollStore, SideStore, or another compatible method.
2. Open **Settings → Detect On-Device**, or select wallpapers and use **Apply** to trigger automatic hash detection.
3. Import `.tendies` files, download wallpapers from Explore, or add saved Favorites to the queue.
4. Select wallpapers or videos and choose **Apply**. Bad Poster applies the collection and performs a full respring where supported.
...
You may need a computer to obtain the PosterBoard App Hash or UUID. Download [Nugget][NuggetGitHub], connect your phone, and follow the helper and detection instructions in Bad Poster Settings. Compatibility depends on the iOS version and jailbreak environment.

## Wallpaper Sources

- [Cowabunga Wallpapers][CowabungaWallpapersPage]
- [CAPlayground Wallpapers][CAPlaygroundWallpapersPage]
- [CAPlayground catalog manifest][CAPlaygroundManifest]
- [Cowabunga Discord Server][CowabungaDiscord]
...
- **[nxtcoreee3][nxtcoreee3GitHub]** — Bad Poster fork, UI and liquid-glass redesign, branding, onboarding, Favorites workflow, provider integration, documentation, and ongoing maintenance
- **[jailbreakdotparty][PartyUIGitHub]** — PartyUI SwiftUI components used for the bounded variable-blur header treatment and Favorites header styling
- **[enkei64][enkei64GitHub]** — CAPlayground development and wallpaper catalog
- **[Mak5er][Mak5erGitHub]** — `bad_query` port, iOS 27 build work, full respring, and on-device detection
- **[LeminLimez][LeminGitHub]** — original Pocket Poster and main PosterBoard tooling
- **[SerStars][SerStarsGitHub]** — website design
- **[Nathan][NathanGitHub]** and **[DuyKhanhTran][DuyKhanhTranGitHub]** — `.Trash` exploit work
- **[forcequitOS][badQueryGitHub]** — `bad_query` for iOS 26/27 sandbox access
- **[dootskyre][dootskyreProfile]** — fallback shortcut creation
- **Community translators** — translations coordinated through [POEditor][POEditorJoin]
- **[PosterRestore][PosterRestoreDiscord]** — PosterBoard assistance

## Third-Party Licenses

Bad Poster includes selected PartyUI components from [jailbreakdotparty/PartyUI][PartyUIGitHub]. PartyUI is licensed under the MIT License; the license text is bundled at [`ThirdPartyLicenses/PartyUI-LICENSE`](ThirdPartyLicenses/PartyUI-LICENSE).
...
[CAPlaygroundWallpapersPage]: https://caplayground.vercel.app/wallpapers
[CAPlaygroundManifest]: https://raw.githubusercontent.com/CAPlayground/wallpapers/refs/heads/main/wallpapers.json
...
[nxtcoreee3GitHub]: https://github.com/nxtcoreee3
[enkei64GitHub]: https://github.com/enkei64
[SerStarsGitHub]: https://github.com/SerStars
...
[dootskyreProfile]: https://bsky.app/profile/did:plc:xykfeb7ieeo335g3aly6vev4
...
[PartyUIGitHub]: https://github.com/jailbreakdotparty/PartyUI
